...
import (
	...
	"github.com/lovexiaoe/golangpros/concurrency/patterns/pooling"
)
...
func performQueries(query int, p *pool.Pool) {
	...
	//	这句我觉得应该放在这里才能模仿真实的访问，而原例子是放在defer语句后面的，
	//那样,goroutine同时启动，同时建立新的链接，导致没有实现资源的复用。
